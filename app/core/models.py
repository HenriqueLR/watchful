...
class ControllEmployee(models.Model):
	...
	id_controll_employee = models.AutoField(primary_key=True, verbose_name=u'Id', 
										    db_column='id_controll_employee')
	employee = models.OneToOneField(User, db_column='employee', related_name='employee_user', 
	...
	date_created = models.DateTimeField(verbose_name='Data Criação', db_column='date_created', 
										auto_now_add=True)
	month = models.IntegerField(verbose_name='Mês', db_column='month', null=True, 
								default=timezone.now().month)
	year = models.IntegerField(verbose_name='Ano', db_column='year', null=True, 
								default=timezone.now().year)
	day =  models.IntegerField(verbose_name='Dia', db_column='day', null=True, 
								default=timezone.now().day)
